...
return [
    ...
    'fw_AutoprovisionTftpPortDescriptionHint' => 'UDP/69 servido pelo servidor TFTP em PHP puro integrado no módulo.<br>Usado por telefones e firmwares que preferem DHCP option 66 (TFTP) ao PnP multicast — historicamente Snom, alguns firmwares Fanvil, bem como redes encaminhadas em que o multicast não atravessa a fronteira L3.<br><b>Protocolo em texto simples:</b> abra a porta apenas no segmento LAN onde os telefones se encontram.',
    ...
    'mod_Autoprovision_http_port_hint' => 'Porta TCP dedicada do módulo para entregar configurações por HTTP puro — não está sujeita ao redireccionamento global para HTTPS. Os telefones devem contactar a PBX nesta porta; a regra de firewall é adicionada automaticamente.',
    ...
    'mod_Autoprovision_tftp_enabled' => 'Activar provisionamento por TFTP (UDP/69)',
    'mod_Autoprovision_tftp_enabled_hint' => 'Inicia um servidor TFTP em PHP puro na UDP/69 que entrega as mesmas configurações por MAC do canal HTTP, bem como firmwares do separador «Firmware».<br>Útil quando o PnP multicast está bloqueado (típico em WiFi de escritório e redes encaminhadas) ou quando o telefone prefere DHCP option 66 (Snom, alguns firmwares Fanvil).<br>Sem binários externos — corre dentro do worker do módulo. <b>Protocolo em texto simples</b>: active apenas numa LAN de confiança. A regra de firewall para UDP/69 é aberta automaticamente.',
    ...
    'mod_Autoprovision_load_examples_hint' => 'Adiciona os modelos de exemplo incluídos para Yealink, Fanvil, Snom, Grandstream e Htek. Os modelos com nomes já existentes são ignorados, pelo que o botão pode ser clicado repetidamente sem risco de duplicados.',
    ...
    'mod_Autoprovision_load_examples_unsaved_warning' => 'Existem alterações não guardadas na página. Carregar os exemplos irá recarregar a página e descartá-las. Continuar?',
    'mod_Autoprovision_load_examples_post_only' => 'É necessário pedido POST.',
    ...
    'mod_Autoprovision_other_pbx_header' => '<b>Atenção!</b> A lista telefónica deve estar acessível em cada PBX no URI <b>/pbxcore/api/autoprovision-http/phonebook</b><br>Indique todos os endereços das PBX das quais a lista telefónica deve ser obtida.<br>',
...
O modelo <b>805e0c67%</b> corresponderá a <b>805e0c670001</b> e <b>805e0c670002</b>',
    'mod_Autoprovision_templates_uri_header' => '<b>Atenção!</b> Todos os URIs são construídos relativamente ao valor base <b>/pbxcore/api/autoprovision-http</b><br>Na descrição de um URI é permitido usar o símbolo <b>%</b> — que significa „qualquer conjunto de caracteres“.<br>O URI <b>/%/%/test.cfg</b> corresponderá a <b>/1/2/test.cfg</b> e a <b>/test/test3/test.cfg</b>',
...
A autoconfiguração é possível apenas para a rede local da empresa, para telefones <b>Yealink, Snom, Fanvil</b>.',
    ...
    'mod_Autoprovision_firmware_header' => 'Carregue ficheiros de firmware que a PBX irá entregar aos telefones por HTTP a partir da porta de provisionamento. Use nos seus modelos o marcador <b>{FIRMWARE_URL}</b> para inserir o URL de descarregamento.',
    'mod_Autoprovision_firmware_drop_hint' => 'Arraste um ficheiro de firmware para aqui ou clique para escolher',
    'mod_Autoprovision_firmware_browse' => 'Escolher ficheiro',
    ...
    'mod_Autoprovision_firmware_filename' => 'Ficheiro',
